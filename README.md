...
- The logo represents both the organisation and the purpose of the website.
...
- The options contain a hover function that changes the colour of the text to white and the background to a dark blue colour, which is in-line with the colour scheme of the logo. It also initiates the feeling of familiarity of the organisation for the user due to the recognition of the same colours. 
...
- A Zoom-in animation was used in order to reflect the vision of the organisation upon the user: A Programme that is focused purely on the Qur'an only.
...
- The Logo was compressed using [TinyPNG](https://tinypng.com/) 
